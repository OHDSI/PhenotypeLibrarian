...
PhenotypeLibrarian::buildPostgresDatabaseSchema(connectionDetails, schemaName, overwrite = TRUE)
PhenotypeLibrarian::importCsvFilesToPostgres(connectionDetails, schemaName, file.path(folder, "export"), winPsqlPath = "bin/")
