...
#
# This file is part of EunomiaPhenotypeLibrary
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "EunomiaPhenotypeLibrary")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "EunomiaPhenotypeLibrary")
  checkInputFileEncoding(pathToCsv)
